...
$configValues['CONFIG_DB_PASS'] = 'biznet99';
...
$configValues['CONFIG_MAIL_SMTPADDR'] = 'smtp2.biz.net.id';
$configValues['CONFIG_MAIL_SMTPPORT'] = '25';
$configValues['CONFIG_MAIL_SMTPAUTH'] = '';
$configValues['CONFIG_MAIL_SMTPFROM'] = 'radius-alert@biz.net.id';
